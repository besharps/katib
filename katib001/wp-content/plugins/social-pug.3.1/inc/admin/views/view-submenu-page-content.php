	...
	<div class="dpsp-page-wrapper dpsp-page-content wrap">
		...
		<h1 class="dpsp-page-title">
			...
			<div class="dpsp-switch">
				<input id="dpsp-sidebar-active" name="dpsp_location_content[active]" class="cmn-toggle cmn-toggle-round" type="checkbox" value="1" <?php echo ( isset( $dpsp_location_content['active'] ) ? 'checked' : '' ) ?> />
