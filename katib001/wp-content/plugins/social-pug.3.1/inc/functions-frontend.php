<?php
	...
	function dpsp_output_meta_tags() {
		...
		echo '<meta property="og:url"			content="' . dpsp_get_post_url() . '" />';
		echo '<meta property="og:type"			content="article" />';
		echo '<meta property="og:title"			content="' . dpsp_get_post_title() . '" />';
		echo '<meta property="og:description" 	content="' . dpsp_get_post_description() . '" />';
		echo '<meta property="og:image" 		content="' . dpsp_get_post_image_url() . '" />';
