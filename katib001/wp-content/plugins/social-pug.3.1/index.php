...
Class Social_Pug {
	...
	public function init_admin_scripts() {
		...
		wp_register_style( 'dpsp-dashboard-style', plugin_dir_url( __FILE__ ) . 'assets/css/style-dashboard.css' );
		...
		wp_register_script( 'dpsp-dashboard-js' , plugin_dir_url( __FILE__ ) . 'assets/js/dashboard.js', array('jquery-ui-sortable', 'jquery' ) );
	...
	public function add_plugin_action_links( $links ) {
		...
		$links[] = '<a href="' . esc_url( get_admin_url( null, 'admin.php?page=dpsp-basic-information' ) ) . '">' . __( 'Settings', 'social-pug' ) . '</a>';
	...
	private function load_resources() {
		...
		if( file_exists( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-basic-info.php' ) )
			include_once( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-basic-info.php' );

		if( file_exists( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-sidebar.php' ) )
			include_once( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-sidebar.php' );

		if( file_exists( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-content.php' ) )
			include_once( DPSP_PLUGIN_DIR . '/inc/admin/submenu-page-content.php' );
